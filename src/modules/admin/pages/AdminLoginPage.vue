...
<template>
  ...
  >
    <!-- Glow blobs -->
    <div
      class="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] blur-3xl opacity-25 pointer-events-none"
      style="background: radial-gradient(circle, rgba(6,182,212,0.4) 0%, transparent 70%);"
    ></div>
    <div
      class="absolute bottom-0 right-0 w-[400px] h-[400px] blur-3xl opacity-15 pointer-events-none"
    ...
    <div class="relative w-full max-w-sm">
      ...
      <!-- Card -->
      <div
        class="rounded-3xl overflow-hidden shadow-2xl shadow-black/50"
        ...
        <div class="px-7 py-8 flex flex-col gap-5">
          ...
          <form class="flex flex-col gap-4" @submit.prevent="handleLogin">
            ...
            <button
              ...
              class="flex items-center justify-center gap-2 w-full py-3 rounded-xl mt-1
